...
- 📍 **当前位置指示**：高亮显示当前可见的提问（蓝点）
- 🌐 **多平台支持**：同时支持 ChatGPT 和 Gemini
- 🖥️ **宽屏模式 (Wide Mode)**：一键扩展对话区域至 90% 宽度，提升阅读体验
- 📋 **智能复制 (Copy Active)**：复制当前高亮问题对应的 AI 回答（自动去除 Markdown 格式）
...
| 按钮 | 功能 |
|------|------|
| **Wide: OFF/ON** | 切换宽屏模式，扩展对话区域宽度 |
| **Copy Active** | 复制当前蓝点高亮问题对应的 AI 回答 |
